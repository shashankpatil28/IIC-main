    ...
    <>
        ...
        <div className="flex h-screen">
            ...
            <div className="max-w-md w-full p-6">
                ...
                <h1 className="text-sm font-semibold mb-4 text-gray-500 text-center">
                Admin can login here to add events in the website{" "}
                </h1>
                <hr className="h-[1.6px] border-t-0 bg-gray-400 opacity-100 mb-4" />
