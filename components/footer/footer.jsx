...
const Footer = () => {
  return (
    <section className="footer w-full px-4 md:px-16 bg-gray-200" id="footer">
          ...
          <div className="flex flex-wrap text-left lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <div className="mt-2 lg:mb-0 mb-6 max-md:mt-4 max-md:relative max-md:bottom-3 max-md:right-1">
                ...
                >
                  <Link
                    href="https://twitter.com/IIC_IIITA"
                    className="flex justify-center items-center"
                  >
                ...
                >
                  <Link
                    href="https://www.facebook.com/iiciiita/"
                    className="flex justify-center items-center"
                  >
                ...
                >
                  <Link
                    href="https://www.instagram.com/iic_iiit_allahabad/?igsh=Z2ljYWFvc3VpY2Z3"
                    className="flex justify-center items-center"
                  >
              ...
              <div className="md:mt-4 max-md:relative max-md:bottom-4">
                <a href="https://mic.gov.in/">
                  <Image objectFit="cover" src={MoeImg} />
                </a>
              </div>
            </div>
            <div className="w-full lg:w-6/12 px-4 max-md:mt-4">
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full md:px-4 ml-auto">
          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-2 mx-auto text-center">
              <div className="text-sm text-blueGray-500 font-semibold py-1">
                Copyright ©{" "}
                <span id="get-current-year" className="text-black">
                  2023
                </span>
                <a
